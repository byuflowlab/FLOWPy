...
function history_tag(alpha, dt, n, nr, rotors, pps=5)
    ...
    p_per_step_tag = "_pps$pps"
    return alpha_tag*dt_tag*n_tag*nr_tag*rotors_tag*p_per_step_tag*"_history.h5"
end
...
pps = [5,5,5]
striders = [1,2,4]
series_names = ["dt = $(round(dt[i]; digits=5))s" for i in 1:length(dt)]
